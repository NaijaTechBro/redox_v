			...
			<article className="admin__post">
				...
				<div className="admin__post__info">
					...
					<span className="admin__post__edit__span">
						<BsPencilSquare onClick={() => handleOpen1(item._id)} />
						<BsTrash3 onClick={() => handleOpen2(item._id)} />
					</span>
				</div>
				<Modal
					isOpen={isOpen1 && item._id === modalIdentifier}
					onClose={() => setIsOpen1(false)}
					contentFn={modalContent1}
				/>
				<Modal
					isOpen={isOpen2 && item._id === modalIdentifier}
