...
const PostDetails = () => {
  ...
  return (
    <div>
        <Navbar/>
        {loader?<div className="loadeer-container">
          <Loader/>
        </div>
        :
        ...
        <div className="post-details-header">
         ...
         <div className="edit-delete-buttons">
            <p className="edit-button" onClick={()=>navigate("/edit/"+postId)} ><BiEdit/></p>
            <p className="delete-button" onClick={handleDeletePost}><MdDelete/></p>
         </div>}
        </div>
        ...
        <img src={IF+post.photo} className="post-image" alt=""/>
         ...
         <div className="post-categories">
          ...
          {post.categories?.map((c,i)=>(
            <>
            <div key={i} className="category-item">{c}</div>
            </>
         ...
         <div className="comment-input-section">
          ...
          <button onClick={postComment} className="comment-button">Add Comment</button>
         </div>
        </div>}
        <Footer/>
    </div>
